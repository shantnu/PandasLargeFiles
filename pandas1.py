...
# Extract the data for only August 2000
london_data_aug_2000 = london_data[
    (london_data['Date'] > pd.to_datetime('2000-08-01')) &
    (london_data['Date'] < pd.to_datetime('2000-08-30'))
]


# Save to Excel
writer = pd.ExcelWriter(
    'London_Aug_2000.xlsx', engine='xlsxwriter')
london_data_cars.to_excel(writer, 'Sheet1')
writer.save()
